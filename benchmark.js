...
// From https://github.com/sindresorhus/yoctocolors/blob/main/benchmark.js
...
import simpleChalk from './dist/esm/index.js';
...
suite
	...
	.addTest('simple-chalk', () => {
		out = simpleChalk.red('Add plugin to use time limit');
		out = simpleChalk.green('Add plugin to use time limit');
		out = simpleChalk.blue(`Add plugin to ${simpleChalk.cyan('use')} time limit`);
	})
	.addTest('cli-color', () => {
